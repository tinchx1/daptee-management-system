      ...
      <v-col cols="12" md="6" lg="4">
        <v-card>
          ...
          <v-card-text>
            ...
            <v-btn variant="text" color="primary" to="/users" class="px-0">
              View all users
      ...
      <v-col cols="12" md="6" lg="4">
        <v-card>
          ...
          <v-card-text>
            ...
            <v-btn variant="text" color="primary" to="/products" class="px-0">
              View all products
              <v-icon icon="mdi-chevron-right" end></v-icon>
            </v-btn>
          </v-card-text>
        ...
        <v-card>
          ...
          <v-card-text>
            <v-list v-if="!isLoading && activities.length > 0">
              <v-list-item v-for="(activity, index) in activities" :key="index" :title="activity.description"
